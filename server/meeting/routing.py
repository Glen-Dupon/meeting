...
class ballcallConsumer(CoolBFFAPIConsumer):
...
def get_app():
    print("======================get app=======================")
    if hasattr(ballcallConsumer, 'as_asgi'):
        return ballcallConsumer.as_asgi()
    else:
        return ballcallConsumer
...
application = ProtocolTypeRouter({
    ...
    # "websocket": URLRouter(
    #     ballcallConsumer.routing.websocket_urlpatterns
    # ),
