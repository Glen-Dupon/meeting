...
class User(utils.BaseModel, model.AbstractUserMixin):
    ...
    language = models.CharField('语言', max_length=64, null=False, default='',choices=LANGUAGE_TYPE_CHOICES)
    country = models.CharField('国家',max_length=64, blank=True, null=False, default='中国')
